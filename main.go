...
import (
	...
	rootHandler "Alkitab/root/handler"

	passageHandler "Alkitab/passage/handler"
	passageRepository "Alkitab/passage/repository"
	passageService "Alkitab/passage/service"

	listHandler "Alkitab/list/handler"
	listRepository "Alkitab/list/repository"
	listService "Alkitab/list/service"
